...
class HomeFragment : Fragment(), Adapter.DownloadClickInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // on below line initializing our adapter class.
        notesRVAdapter = Adapter(notesRVModalArrayList, context!!, this)
        ...
        ascva.addTextChangedListener(object : TextWatcher {
    ...
    override fun onDownloadClick(position: Int, notesRVModal: Model, holder: Adapter.ViewHolder) {
            dialogShowdata(notesRVModal)
    }

    private fun dialogShowdata(notesRVModal: Model) {
